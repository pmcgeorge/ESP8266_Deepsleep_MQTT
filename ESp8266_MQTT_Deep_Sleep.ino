/*
 ...
 Hookup guide:
 - connect Huzzah GPIO 16 pin to RST pin in order to enable the ESP8266 to wake up periodically
 - DS18B20:
     + connect VCC (3.3V) to the appropriate DS18B20 pin (VDD)
     + connect GND to the appopriate DS18B20 pin (GND)
     + connect GPIO 2 to the DS18B20 data pin (DQ)
...
const char* mqtt_topic = "sensors/freezer/temperature";
